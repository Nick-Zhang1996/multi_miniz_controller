...
// Atmega328p
#if not defined(ARDUINO_AVR_PRO) && not defined(ARDUINO_MULTI_NO_BOOT) &&      \
    not defined(ARDUINO_MULTI_FLASH_FROM_TX) &&                                \
    not defined(ARDUINO_AVR_MINI) && not defined(ARDUINO_AVR_NANO) &&          \
...
#endif
#if F_CPU != 16000000L ||                                                      \
    not(defined(__AVR_ATmega328P__) || defined(__AVR_ATmega168__))
#error You must select the processor type "ATmega328(5V, 16MHz)"
#endif
#endif
#if defined(STM32_BOARD) && not defined(ORANGE_TX)
// STM32
#if not defined(ARDUINO_GENERIC_STM32F103C) &&                                 \
    not defined(ARDUINO_MULTI_STM32_FLASH_FROM_TX) &&                          \
    not defined(ARDUINO_MULTI_STM32_NO_BOOT) &&                                \
    not defined(ARDUINO_MULTI_STM32_WITH_BOOT)
...
// AVR
     ...
     ARDUINO_MULTI_NO_BOOT < MIN_AVR_BOARD) ||                                 \
    (defined(ARDUINO_MULTI_FLASH_FROM_TX) &&                                   \
     ARDUINO_MULTI_FLASH_FROM_TX < MIN_AVR_BOARD)
...
#endif
// STM32
#if (defined(ARDUINO_MULTI_STM32_NO_BOOT) &&                                   \
     ARDUINO_MULTI_STM32_NO_BOOT < MIN_STM32_BOARD) ||                         \
    (defined(ARDUINO_MULTI_STM32_FLASH_FROM_TX) &&                             \
     ARDUINO_MULTI_STM32_FLASH_FROM_TX < MIN_STM32_BOARD) ||                   \
    (defined(ARDUINO_MULTI_STM32_WITH_BOOT) &&                                 \
     ARDUINO_MULTI_STM32_WITH_BOOT < MIN_STM32_BOARD)
...
// Error if CHECK_FOR_BOOTLOADER is not enabled but a FLASH_FROM_TX board is
// selected
#if (defined(ARDUINO_MULTI_FLASH_FROM_TX) ||                                   \
     defined(ARDUINO_MULTI_STM32_FLASH_FROM_TX)) &                             \
    !defined(CHECK_FOR_BOOTLOADER)
#if defined(STM32_BOARD)
#error                                                                         \
    "You have selected the 'Flash from TX' upload method but not enabled CHECK_FOR_BOOTLOADER."
#else
#error                                                                         \
    "You have selected the 'Flash from TX' bootloader but not enabled CHECK_FOR_BOOTLOADER."
#endif
#endif
...
#error                                                                         \
    "The CORONA forced frequency tuning value is outside of the range -127..127."
#endif
#endif
#ifdef FORCE_FRSKYD_TUNING
#if (FORCE_FRSKYD_TUNING < -127) || (FORCE_FRSKYD_TUNING > 127)
#error                                                                         \
    "The FrSkyD forced frequency tuning value is outside of the range -127..127."
#endif
#endif
#ifdef FORCE_FRSKYL_TUNING
#if (FORCE_FRSKYL_TUNING < -127) || (FORCE_FRSKYL_TUNING > 127)
#error                                                                         \
    "The FrSkyL forced frequency tuning value is outside of the range -127..127."
#endif
#endif
...
#error                                                                         \
    "The FrSkyX forced frequency tuning value is outside of the range -127..127."
#endif
#endif
#ifdef FORCE_HITEC_TUNING
#if (FORCE_HITEC_TUNING < -127) || (FORCE_HITEC_TUNING > 127)
#error                                                                         \
    "The HITEC forced frequency tuning value is outside of the range -127..127."
#endif
#endif
#ifdef FORCE_HOTT_TUNING
#if (FORCE_HOTT_TUNING < -127) || (FORCE_HOTT_TUNING > 127)
#error                                                                         \
    "The HOTT forced frequency tuning value is outside of the range -127..127."
#endif
#endif
#ifdef FORCE_REDPINE_TUNING
#if (FORCE_REDPINE_TUNING < -127) || (FORCE_REDPINE_TUNING > 127)
#error                                                                         \
    "The REDPINE forced frequency tuning value is outside of the range -127..127."
#endif
#endif
#ifdef FORCE_RADIOLINK_TUNING
#if (FORCE_RADIOLINK_TUNING < -127) || (FORCE_RADIOLINK_TUNING > 127)
#error                                                                         \
    "The RADIOLINK forced frequency tuning value is outside of the range -127..127."
#endif
#endif
#ifdef FORCE_FUTABA_TUNING
#if (FORCE_FUTABA_TUNING < -127) || (FORCE_FUTABA_TUNING > 127)
#error                                                                         \
    "The Futaba forced frequency tuning value is outside of the range -127..127."
#endif
#endif
#ifdef FORCE_SKYARTEC_TUNING
#if (FORCE_SKYARTEC_TUNING < -127) || (FORCE_SKYARTEC_TUNING > 127)
#error                                                                         \
    "The SKYARTEC forced frequency tuning value is outside of the range -127..127."
#endif
#endif
// A7105
...
#error                                                                         \
    "The AFHDS2A forced frequency tuning value is outside of the range -300..300."
#endif
#endif
#ifdef FORCE_BUGS_TUNING
#if (FORCE_BUGS_TUNING < -300) || (FORCE_BUGS_TUNING > 300)
#error                                                                         \
    "The BUGS forced frequency tuning value is outside of the range -300..300."
#endif
#endif
#ifdef FORCE_FLYSKY_TUNING
#if (FORCE_FLYSKY_TUNING < -300) || (FORCE_FLYSKY_TUNING > 300)
#error                                                                         \
    "The Flysky forced frequency tuning value is outside of the range -300..300."
#endif
#endif
#ifdef FORCE_HEIGHT_TUNING
#if (FORCE_HEIGHT_TUNING < -300) || (FORCE_HEIGHT_TUNING > 300)
#error                                                                         \
    "The Height forced frequency tuning value is outside of the range -300..300."
#endif
#endif
#ifdef FORCE_PELIKAN_TUNING
#if (FORCE_PELIKAN_TUNING < -300) || (FORCE_PELIKAN_TUNING > 300)
#error                                                                         \
    "The Pelikan forced frequency tuning value is outside of the range -300..300."
#endif
#endif
#ifdef FORCE_HUBSAN_TUNING
#if (FORCE_HUBSAN_TUNING < -300) || (FORCE_HUBSAN_TUNING > 300)
#error                                                                         \
    "The Hubsan forced frequency tuning value is outside of the range -300..300."
#endif
#endif
#ifdef FORCE_JOYSWAY_TUNING
#if (FORCE_JOYSWAY_TUNING < -300) || (FORCE_JOYSWAY_TUNING > 300)
#error                                                                         \
    "The JOYSWAY forced frequency tuning value is outside of the range -300..300."
#endif
#endif
#ifdef FORCE_KYOSHO_TUNING
#if (FORCE_KYOSHO_TUNING < -300) || (FORCE_KYOSHO_TUNING > 300)
#error                                                                         \
    "The Kyosho forced frequency tuning value is outside of the range -300..300."
#endif
#endif
#ifdef FORCE_WFLY2_TUNING
#if (FORCE_WFLY2_TUNING < -300) || (FORCE_WFLY2_TUNING > 300)
#error                                                                         \
    "The WFLY2 forced frequency tuning value is outside of the range -300..300."
#endif
#endif
...
#error                                                                         \
    "Error Channel 15 conflict between the CYRF6936 freq tuning and the DSM throttle kill feature."
#endif
...
#define MULTI_5IN1_INTERNAL                                                    \
  JP_T18 // make JP_T18 default if it has not been explicitly declared
#endif
...
#undef E016HV2_CC2500_INO
#undef ESKY150V2_CC2500_INO
#undef IKEAANSLUTA_CC2500_INO // This is mostly a "for-fun" kind of a thing, not
...
// OpenTX 2.3.x issue
#if defined(FRSKYD_CC2500_INO) || defined(FRSKYV_CC2500_INO) ||                \
...
#undef MT99XX_HUB_TELEMETRY
#endif
#if not defined(FRSKYD_CC2500_INO) && not defined(MLINK_HUB_TELEMETRY) &&      \
    not defined(BAYANG_HUB_TELEMETRY)
// protocols using FRSKYD user frames
#undef HUB_TELEMETRY
#endif
#if not defined(HOTT_FW_TELEMETRY) && not defined(DSM_TELEMETRY) &&            \
    not defined(SPORT_TELEMETRY) && not defined(HUB_TELEMETRY) &&              \
    not defined(HUBSAN_HUB_TELEMETRY) && not defined(BUGS_HUB_TELEMETRY) &&    \
    not defined(NCC1701_HUB_TELEMETRY) && not defined(BAYANG_HUB_TELEMETRY) && \
    not defined(CABELL_HUB_TELEMETRY) && not defined(RLINK_HUB_TELEMETRY) &&   \
    not defined(AFHDS2A_HUB_TELEMETRY) && not defined(AFHDS2A_FW_TELEMETRY) && \
    not defined(MULTI_TELEMETRY) && not defined(MULTI_STATUS) &&               \
    not defined(HITEC_HUB_TELEMETRY) && not defined(HITEC_FW_TELEMETRY) &&     \
    not defined(SCANNER_TELEMETRY) && not defined(FRSKY_RX_TELEMETRY) &&       \
    not defined(AFHDS2A_RX_TELEMETRY) && not defined(BAYANG_RX_TELEMETRY) &&   \
    not defined(DEVO_HUB_TELEMETRY) && not defined(PROPEL_HUB_TELEMETRY) &&    \
    not defined(OMP_HUB_TELEMETRY) && not defined(V761_HUB_TELEMETRY) &&       \
    not defined(SGF22_HUB_TELEMETRY) && not defined(XK2_HUB_TELEMETRY) &&      \
    not defined(FX_HUB_TELEMETRY) && not defined(KAMTOM_HUB_TELEMETRY) &&      \
    not defined(YUXIANG_HUB_TELEMETRY) && not defined(WFLY2_HUB_TELEMETRY) &&  \
    not defined(LOLI_HUB_TELEMETRY) && not defined(MLINK_HUB_TELEMETRY) &&     \
    not defined(MLINK_FW_TELEMETRY) && not defined(MT99XX_HUB_TELEMETRY) &&    \
    not defined(MULTI_CONFIG_INO)
#undef TELEMETRY
#undef INVERT_TELEMETRY
#undef MULTI_TELEMETRY
#endif
...
#endif
#endif
#if not defined(STM32_BOARD) || not defined(TELEMETRY) ||                      \
    (not defined(FRSKY_RX_TELEMETRY) && not defined(AFHDS2A_RX_TELEMETRY) &&   \
     not defined(BAYANG_RX_TELEMETRY) && not defined(DSM_RX_CYRF6936_INO))
#undef SEND_CPPM
#endif

// Check if Direct inputs defined correctly
#if defined(ENABLE_DIRECT_INPUTS)
#if not defined(STM32_BOARD) || not defined(ENABLE_PPM) ||                     \
    defined(ENABLE_SERIAL)
#error You can enable dirct inputs only in PPM mode and only for STM32 board.
#endif

#if not defined(DI1_PIN) && not defined(DI2_PIN) && not defined(DI3_PIN) &&    \
    not defined(DI4_PIN)
#error You must define at least 1 direct input pin or undefine ENABLE_DIRECT_INPUTS in config.
#endif

#if not defined(DI_CH1_read) && not defined(DI_CH2_read) &&                    \
    not defined(DI_CH3_read) && not defined(DI_CH4_read)
